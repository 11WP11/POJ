public class Main {
   ...
   public static void main(String[] args) {
        ...
        System.out.println("Minivan poterzbuje: "+miniVanFuelcap/miniVanLkm*100/100*7 +" litrów paliwa.");
        System.out.println("Auto sportowe poterzbuje: "+sportsCarFuelcap/sportsCarLkm*100/100*17 +" litrów paliwa.");
   }
}